...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'array',
      title: 'Frases Clave',
      description: 'Frases inspiradoras relacionadas con este concepto.',
      of: [
        defineField({
          name: 'phraseItem',
          type: 'object',
    ...
    defineField({
      ...
      description: 'Lista de libros recomendados relacionados con este concepto.',
      of: [
        defineField({
          name: 'bookItem',
          type: 'object',
          ...
          fields: [
            ...
            defineField({ 
              ...
              type: 'array', 
              title: 'Descripción',
              description: 'Breve descripción del libro y su relevancia para este concepto.',
              of: [{ type: 'block' }] 
            }),
          ],
        }),
